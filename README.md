...
- **data**: Single-cell results from `collect_mi_results.csv`
- **parameters**: computed in notebook, also given in `analysis/final_results/scaling_plots*`
...
- [train_gisaid_model.py](seq/train_gisaid_model.py): Fine-tune ESM2 models (8M, 35M, 150M parameters) on noised sequences
...
- [data.py](scaling_laws/scaling_laws/prepare/data.py): `PrepareData` and `Experiments` classes for dataset management, downsampling, and tokenization
